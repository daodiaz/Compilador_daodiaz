...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 28 20:33:53 CEST 2021
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		if(mv instanceof ExpresionAritmetica){
		...
		SymbolIF vector; 
		if(scopeManager.containsSymbol(nombre_vector)){
		...
		switch(vector.getTypeSimple()){
			case "entero":
				...
				primitiva.setNombreVector(nombre_vector);
				RESULT = primitiva;
				break;
			case "boolean": 
				...
				break;
			default:
				throw new RuntimeException("Los vectores solo pueden estar conformados de enteros o lógicos, actualmente: " + vector.getTypeSimple());		
		...
		if(mv instanceof PrimitivaAritmetica) {
			...
			if( valor_miembro != null){
				RESULT = valor_miembro;
			} else {
				throw new RuntimeException("El valor del miembro del vector no está inicialiado todavía, es null.");
			}
		} else
			throw new RuntimeException("Sólo se pueden instanciar rangos de valores enteros, el miembro de vector es de valor: " + mg.getClass().getSimpleName());
		...
		int valor = Integer.parseInt(rango.getValue());
		RESULT = valor;
		...
		System.out.println("Analizando declaración de vactor de enteros");
		RESULT = "entero";
		...
		if(!scope.getScopeManager().containsType((String) tipo)){
			if(tipo.equals("entero")){
				...
				throw new RuntimrException("Los tipos compuestos sólo pueden estar formados por tipos enteros o lógicos");
			}
		} else {
		...
		PrimitivaAritemetica primitiva = new PrimitivaAritmetica(null,null,null);
		RESULT= primitiva;
		...
		if(valor instanceof PrimitivaAritmetica){
			if(syTable.containsSymbol()){
				throw new RuntimeException("Ya existe una constante en este ámbito con el mismo nombre: " + nombre_variable);
			}
