...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 06 00:51:12 CEST 2021
  */
...
.getRango() + " y se trata de acceder al miembro " + (int) rango);
		...
		if(mv instanceof PrimitivaAritmetica) {
			...
			//Creo la primitiva.	
			PrimitivaAritmetica vector = new PrimitivaAritmetica();
		...
		//Creo la primitiva.	
		PrimitivaAritmetica rango = new PrimitivaAritmetica();
		rango.setValor(valor);
