...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun May 23 23:35:20 CEST 2021
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		if(piz instanceof SymbolBase){
			...
			} else if(pi.getType().getName().equals(pd.getType())){
				asign = new SentenciaAsignacion((SymbolIF) pi,(Expresion) pd, pd.getType());
				System.out.println("Sentencia de asignación vector analizada: " + pd.getType());
			} else
		...
		int rango = ((PrimitivaAritmetica) prim).getValor();
			...
			switch(identificador.getClass().getSimpleName()){
				...
				case "SymbolParameter":
					if(identificador.getType().getName().equals("entero")){
						...
						semanticErrorManager.semanticFatalError("No se puede utilizar una constante de tipo " + identificador.getType().getName() + " como parte de una expresión aritmética o lógica, sólo está permitido enteros o primitivas lógicas.");
