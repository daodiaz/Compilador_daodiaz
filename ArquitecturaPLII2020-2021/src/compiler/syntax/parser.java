...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 29 21:49:33 CEST 2021
  */
      ...
      switch (CUP$parser$act_num)
		...
		if(scopeManager.containsSymbol(nombre_vector) && (scopeManager.searchSymbol(nombre_vector).getType() instanceof TypeArray)){
			...
			if((int) rango >= ((TypeArray) vector.getType()).getRango()){
				throw new RuntimeException("Intento de acceso al array " + nombre_vector + " fuera de rango, su tamaño es " + ((TypeArray) vector.getType()).getRango() + " y se trata de acceder al miembro " + (int) rango);
			}
